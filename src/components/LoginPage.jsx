                ...
                {browserInfo.isInApp && (
                    <div className="bg-[#FF9F43]/20 border-2 border-[#FF9F43] rounded-lg p-4 mb-4 text-left">
                        <div className="flex items-start gap-2 mb-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[#636E72] mt-1">
                                    Google 登入可能無法在 LINE、Facebook 等 App 內正常運作
                                </p>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full mt-3 py-2 px-3 bg-white border-2 border-[#FF9F43] rounded-lg text-sm font-bold text-[#FF9F43] flex items-center justify-center gap-2 active:bg-[#FF9F43]/10"
                        >
                            {copied ? (
                                <><Check size={16} /> 已複製網址！</>
                            ) : (
                                <><Copy size={16} /> 複製網址到外部瀏覽器</>
                            )}
                        </button>
                    </div>
                )}
